<template>
  <div>
    <div class="hot-search-title">
      ...
      <span class="btn" @click="titleClick">{{btn}}</span>
    </div>
    <div class="hot-search-list">
      <div class="hot-search-item" v-for="(item, index) in hotSearch" :key="index" @click="selectItem(item)">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      selectItem (item) {
        // 选中某个搜索记录后，跳转到相关页面
        this.$router.push(`/store/list?keyword=${item.text}`)
      }
    },
    mounted() {
