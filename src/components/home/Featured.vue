<template>
  <div class="featured">
    <title-view :label="titleText" :btn="btnText" v-if="titleVisible && data && data.length > 0" @onClick="change"></title-view>
    <div class="featured-list" :data="showData">
      <div class="featured-item-wrapper">
        <div class="featured-item" v-for="(item, index) in showData" :key="index" @click="showBookDetail(item)">
